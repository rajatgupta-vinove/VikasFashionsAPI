...
namespace VikasFashionsAPI.Controllers
{
    ...
    public class WarehouseController : ControllerBase
    {
        ...
        public async Task<ActionResult<Warehouse>> ChangeStatus(int id)
        {
            ...
            {
                return BadRequest(new ResponseGlobal() { ResponseCode = ((int)System.Net.HttpStatusCode.BadRequest), Message = Common.CommonVars.MessageResults.WarehouseNotFound.GetEnumDisplayName() });
            }
