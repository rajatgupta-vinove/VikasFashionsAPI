...
namespace VikasFashionsAPI.Controllers
{
    ...
    public class AreaController : ControllerBase
    {
        ...
        public async Task<ActionResult<Area>> ChangeStatus(int areaId)
        {
            ...
            {
                return BadRequest(new ResponseGlobal() { ResponseCode = ((int)System.Net.HttpStatusCode.BadRequest), Message = Common.CommonVars.MessageResults.AreaNotFound.GetEnumDisplayName() });
            }
