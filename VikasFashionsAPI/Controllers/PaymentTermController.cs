...
;
            ...
            {
                return BadRequest(new ResponseGlobal() { ResponseCode = ((int)System.Net.HttpStatusCode.BadRequest), Message = Common.CommonVars.MessageResults.PaymentTermNotFound.GetEnumDisplayName() });
            }
            var result = await _paymentTermService.ChangePaymentTermStatusAsync(id, paymentTerm.UpdatedBy, paymentTerm.UpdatedOn);
